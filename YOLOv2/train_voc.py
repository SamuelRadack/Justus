...
def get_args():
    ...
    parser.add_argument("--num_epoches", type=int, default=135)
    ...
    parser.add_argument("--data_path", type=str, default=r"C:\Users\sam\Downloads\yoloV2\Yolo-v2-pytorch-master\data\VOCdevkit", help="the root folder of dataset")
    ...
    parser.add_argument("--saved_path", type=str, default=r"C:\Users\sam\Downloads\yoloV2\Yolo-v2-pytorch-master\trained_models")
    ...
    for epoch in range(opt.num_epoches):
        ...
        if epoch % opt.test_interval == 0:
            ...
            if te_loss + opt.es_min_delta < best_loss:
                ...
                torch.save(model.state_dict(), opt.saved_path + os.sep + "only_params_trained_yolo_voc_res.pt")
                torch.save(model, opt.saved_path + os.sep + "whole_model_trained_yolo_fin.pt")
